  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        aptos: {
          DEFAULT: "#663399", // Deep purple
          "gradient-start": "#A020F0", // Lighter purple for gradient
          "gradient-end": "#007BFF", // Blue for gradient
        },
      },
      borderRadius: {
        lg: "var(--radius)",
       ...
       boxShadow: {
        'glow': '0 0 20px rgba(102, 51, 153, 0.5)', // Deep purple glow
       },
       keyframes: {
         "accordion-down": {
          from: { height: "0" },
